...
class StandbyKeyword extends ConsumerStatefulWidget {
  const StandbyKeyword({super.key});

  @override
  ConsumerState<StandbyKeyword> createState() => _BlogListPlaceState();
}

class _BlogListPlaceState extends ConsumerState<StandbyKeyword> {
  int browserNumber = 1;
  ...
  Widget build(
    ...
    final blogs = ref.watch(standbyProvier);
