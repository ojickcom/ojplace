...
import 'package:ojplace/jawan_list/mvvm/copy_input_db3.dart';
...
class EventNow extends ConsumerStatefulWidget {
  const EventNow({super.key});

  @override
  ConsumerState<EventNow> createState() => _BlogListPlaceState();
}

class _BlogListPlaceState extends ConsumerState<EventNow> {
  int browserNumber = 1;
  ...
  Widget build(
    ...
    final blogs = ref.watch(eventProvider);
